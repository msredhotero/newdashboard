...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_aif'], '../documentod/');
//*** FIN  ****/
							...
							<div class="row">
								<div class="col-xs-12 col-md-12 col-lg-12">
									<div class="alert alert-success">
										<p><b>SUBA UNA FOTO DE SU DNI TARJETA DORSAL. PROCURE QUE TODOS LOS DATOS SEAN LEGIBLES Y QUE LA CAMARA ESTE LO MAS CERCA POSIBLE DENTRO DE LOS LIMITES DEL DNI. SAQUE LA FOTO CON EL CELULAR EN HORIZONTAL.</b></p>
									</div>
								</div>
