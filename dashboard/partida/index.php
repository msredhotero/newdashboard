...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_aif'], '../partida/');
//*** FIN  ****/
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card ">
						<div class="header bg-blue">
							<h2>
								Partida de Nacimiento/Libreta de Matrimonio (pdf)
							</h2>
	...
	function traerImagen() {
		$.ajax({
			...
			success:  function (response) {
				if (response.datos.estado != 'No Cargo Ninguna Imagen') {
		...
		function presentar() {
			$.ajax({
				...
				success:  function (response) {
					...
					swal("Correcto!", 'Se presento la documentacion Partida de Nacimiento/Libreta de Matrimonio', "success");
